...
`inputs.json`, and invokes the public `graphblocks run` CLI. Compilation uses the
normative Rust binding; execution uses the deterministic Python runtime backend.
