...
def core_stdlib_implementations(
    resolve: Callable[[str], BlockCallable],
) -> Mapping[str, BlockCallable]:
    """Return implementation-id handlers for built-in non-extension blocks."""

    return MappingProxyType(
        {
            "graphblocks.stdlib.prompt.render": prompt_render,
            "graphblocks.stdlib.scripted_model.generate": scripted_generate,
            "graphblocks.stdlib.tools.resolve": resolve_tools,
            "graphblocks.stdlib.agent.run": scripted_agent_run,
            "graphblocks.stdlib.conversation.begin_turn": begin_turn,
            "graphblocks.stdlib.conversation.commit_turn": commit_turn,
            "graphblocks.stdlib.conversation.policy_stop_turn": policy_stop_turn,
            "graphblocks.stdlib.async.start_operation": async_start_operation,
            "graphblocks.stdlib.async.await_callback": async_await_callback,
            "graphblocks.stdlib.async.poll_operation": async_poll_operation,
            "graphblocks.stdlib.async.complete_operation": async_complete_operation,
            "graphblocks.stdlib.async.cancel_operation": async_cancel_operation,
            "graphblocks.stdlib.async.expire_operation": async_expire_operation,
            "graphblocks.stdlib.control.map": _control_map_handler(resolve),
            "graphblocks.stdlib.control.select": control_select,
        }
    )
