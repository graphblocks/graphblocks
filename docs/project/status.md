...
runtime protocol-handshake transitions are implemented, while standalone
canonical/schema-facade and production scheduler/durable authority still block
the complete authority gate.
