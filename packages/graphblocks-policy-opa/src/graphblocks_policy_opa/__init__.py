...
from graphblocks import PolicyDecision, PolicyObligation, PolicyRequest, canonical_dumps


VALID_POLICY_EFFECTS = frozenset({"allow", "deny", "allow_with_obligations", "defer"})
