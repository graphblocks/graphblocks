...
- Python `AsyncOperationResult` now validates output, artifacts, diagnostics, metrics, checks, and
  ...
  after journaling. Projection helpers reject malformed non-sequence and string inputs before
  validating individual projection items or external effect records.
