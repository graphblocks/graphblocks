...
- Durable background-run shared TCK cases now require nonblank event `eventId`/`event_id`,
  ...
  run cursor before proving cursor replay, preventing anonymous, cross-run, duplicate, ambiguous,
  untyped, cursorless, untimestamped, or unordered events from satisfying replay assertions.
